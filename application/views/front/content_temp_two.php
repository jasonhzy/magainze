<?php $this->load->view('front/header')?>
           	<div class="textcontent">
                ...
                <div class="ny_a41">
	                ...
	                <div class="ny_contenttop" style="margin:<?=$article_detail['profile_space'] ?>;height:<?=$article_detail['profile_height'] ?>px;">
	                      <span style="font-size:<?=$fontsize ?>px;"><?=$article_detail['profile'] ?> </span>           
	                </div>
	                <div class="ny_contentbottom" style="margin:<?=$article_detail['content_space'] ?>;height:<?=$article_detail['content_height'] ?>px;">
	                       <span style="font-size:<?=$fontsize ?>px;"><?=$article_detail['content'] ?>  </span>       
	                </div>
                </div>
                <div class="textcon4">
